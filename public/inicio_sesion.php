...
<body>
    ...
    <div class="login-clean" style="background: url(&quot;assets/img/17735.jpg&quot;) left / cover, rgba(0,0,0,0);font-family: Roboto, sans-serif;">
        <form action="procesar_login.php" method="post" style="background: rgb(218,212,212);border-radius: 18px;">
            <div class="illustration">
                <h2 class="text-center" style="color: rgb(19,21,23);font-size: 30px;">Iniciar Sesión</h2>
                <i class="fas fa-user-circle" style="color: rgb(177,10,10);"></i>
            </div>
            ...
            <div class="form-group">
                <button class="btn btn-primary btn-block" type="submit" style="background: rgb(177,10,10);">Ingresar</button>
            </div>
            <small class="form-text text-muted" style="text-align: center;">¿No tenés una cuenta?</small>
            <a class="forgot" href="registrarse.php" style="margin-top: 10px;color: rgb(31,33,35);font-size: 20px;">Crear Cuenta</a>
        </form>
    </div>
