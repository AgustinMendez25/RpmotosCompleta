    ...
    <main>
        ...
        <div class="carousel slide" data-ride="carousel" id="carousel-1">
            <div class="carousel-inner">
                <div class="carousel-item active"><img class="w-100 d-block" src="/img/1Slider.jpg" alt="Slide Image" style="max-height: 700px;"></div>
                <div class="carousel-item"><img class="w-100 d-block" src="/img/2Slider.jpg" alt="Slide Image" style="max-height: 700px;"></div>
                <div class="carousel-item"><img class="w-100 d-block" src="/img/3Slider.jpg" alt="Slide Image" style="max-height: 700px;"></div>
            </div>
            <div>
    ...
    <footer>
        <div class="row d-flex justify-content-center" style="margin-right: 0px;margin-left: 0px;">
            <div class="col-10 col-md-4 text-center">
                <img class= "logo" style="margin:30px 0px;" src="/img/logo.png">
