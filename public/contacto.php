...
<body>
    ...
    <div class="row justify-content-center" style="margin-right: 0;margin-left: 0;font-family: Roboto, sans-serif;">
        <div class="col-sm-9 col-md-8 col-xl-7">
            <div style="margin-top: 24px;margin-bottom: 24px;padding: 20px;">
                <form action="enviar_correo.php" method="post">
                    <h2 class="text-center espacio">Envíanos tu consulta</h2>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="tel" placeholder="Ingrese su número de teléfono" required="">
                    </div>
                    <div class="form-group">
                        <label>Mensaje</label>
                        <textarea class="form-control" name="mensaje" rows="14" required=""></textarea>
                    </div>
                    <div class="form-group">
                        <button class="btn btn-danger" type="submit" name="enviar" style="background: rgb(177,10,26);">Enviar</button>
                    </div>
                </form>
            </div>
        </div>
