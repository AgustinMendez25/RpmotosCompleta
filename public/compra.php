...
<body>
    ...
    <div class="row d-flex justify-content-center" style="margin-right: 0;margin-left: 0;padding: 40px;font-family: Roboto, sans-serif;">
        <div class="col-sm-12 col-md-10 col-xl-9">
            <div class="row text-center" style="background: #ffffff;border-radius: 8px;">
                <div class="col-12">
                    <h1 class="espacio">Carrito</h1>
                </div>
                <?php
                    if (($envio->num_rows)==0){
                ?>
                ...
                <?php } else{ ?>
                <div class="table-responsive" style="padding: 0px 30px 30px 30px">
                    <table class="table table-bordered">
                        ...
                        <tbody style="font-size: 15px;">
                            <?php while($row=$envio->fetch_assoc()){ ?>
                            <tr>
                                ...
                                <td>
                                    <a href="modificar_productocarrito.php?id_compra=<?php echo $row['id_compra']; ?>">
                                        <button class="btn btn-primary" type="button" style="margin-right:15px">Editar</button>
                                    </a>
                                </td>
                                <td>
                                    <a href="eliminar_productocarrito.php?id_compra=<?php echo $row['id_compra']; ?>">
                    ...
                    <div class="col-12 d-flex justify-content-end">
                        <a href="solicitar_presupuesto.php?usuario=<?php echo $_SESSION['idUsuario']; ?>">
                            <button class="btn btn-success" type="button">Solicitar Presupuesto</button>
                        </a>
                    </div>
                </div>
                <?php } ?>
