        ...
        <div class="col-sm-12 col-md-10 col-xl-6">
            <div class="row text-center" style="background: #ffffff;border-radius: 8px;">
                <?php
                    ...
                    $query = "SELECT * FROM carrito WHERE id_compra=".$id;
                    $envio = $conexion->query($query);
                    $row=$envio->fetch_assoc();
                ?>
                <div class="col-12">
                    <h1 class="espacio">Editar cantidad de producto</h1>
                </div>
                <div class="col-12">
                    <form action="realizar_modificacioncarrito.php?id_compra=<?php echo $id ?>" method="post" style="margin-right: 3%;margin-left: 3%;">
                        <div class="form-group" style="width:70px">
                            <label>Cantidad</label>
                            <input class="form-control" type="number" name="cantidad" value="<?php echo $row['cantidad_solicitada'] ?>" required="">
                        </div>
                        <div class="form-group">
                            <button class="btn btn-dark" type="submit" name="enviar">Guardar</button>
                        </div>
                    </form>
                </div>
            </div>
